export const ICONS = {
  ...
  'ai-center': '<svg class="icon" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="4" y="6" width="16" height="12" rx="4" stroke="currentColor" stroke-width="2.2"/><circle cx="9" cy="12" r="1.2" fill="currentColor"/><circle cx="15" cy="12" r="1.2" fill="currentColor"/><path d="M12 3v3M8 20h8" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',
  'ia-foundry': '<svg class="icon" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="4" y="6" width="16" height="12" rx="4" stroke="currentColor" stroke-width="2.2"/><circle cx="9" cy="12" r="1.2" fill="currentColor"/><circle cx="15" cy="12" r="1.2" fill="currentColor"/><path d="M12 3v3M8 20h8" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',
